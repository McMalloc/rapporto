// https://forum.processing.org/two/discussion/11549/texture-on-a-deformed-plane-is-bent-how-do-i-fix-it
// modified to dynamically load image
// =============================================================
...
public final class QuadGrid {
     ...
     */
    public QuadGrid(int nbrXslices, int nbrYslices) {
        this.img = null;
    ...
    public void drawGrid(PApplet app, PGraphics img) {
        if (vp == null) return;
